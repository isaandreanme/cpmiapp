...
class Batang extends BaseWidget
{
    ...
    protected function getStats(): array
    {
        ...
        $NEW = DataPmi::where('kantor_id', '2')->where('status_id', '1')->count();
        ...
        return [
            Stat::make('BARU', $NEW)
                ...
                ->extraAttributes([
                    ...
                    'onclick' => "window.open('/admin/data-pmis?tableFilters[Status][values][0]=1&tableFilters[Kantor][value]=2', '_blank')",
                ])
            ...
            Stat::make('DIPROSES', $DIPROSES)
                ...
                ->extraAttributes([
                    'class' => 'cursor-pointer',
                    'onclick' => "window.open('/admin/data-pmis?tableFilters[Status][values][0]=2&tableFilters[Kantor][value]=2', '_blank')",
                ])
                ->chart(generateRandomChartData(9)), // Replace 7 with the desired number of data points,
            ...
            Stat::make('SUDAH MARKET', $MARKET)
                ...
                ->extraAttributes([
                    'class' => 'cursor-pointer',
                    'onclick' => "window.open('/admin/data-pmis?tableFilters[Status][values][0]=2&tableFilters[Agency][value]=1&tableFilters[Kantor][value]=2', '_blank')",
                ])
                ->chart(generateRandomChartData(9)), // Replace 7 with the desired number of data points,
            ...
            Stat::make('BELUM MARKET', $NONMARKET)
                ...
                ->extraAttributes([
                    'class' => 'cursor-pointer',
                    'onclick' => "window.open('/admin/data-pmis?tableFilters[Status][values][0]=2&tableFilters[Agency][value]=22&tableFilters[Kantor][value]=2', '_blank')",
                ])
                ->chart(generateRandomChartData(9)), // Replace 7 with the desired number of data points,
            ...
            Stat::make('DAPAT JOB', $TOTALJOB)
                ...
                ->extraAttributes([
                    'class' => 'cursor-pointer',
                    'onclick' => "window.open('/admin/data-pmis?tableFilters[Status][values][0]=2&tableFilters[job][value]=1&tableFilters[Kantor][value]=2', '_blank')",
                ])
                ->chart(generateRandomChartData(9)), // Replace 7 with the desired number of data points,
            ...
            Stat::make('BELUM JOB', $TOTALNONJOB)
                ...
                ->extraAttributes([
                    'class' => 'cursor-pointer',
                    'onclick' => "window.open('/admin/data-pmis?tableFilters[Status][values][0]=2&tableFilters[job][value]=0&tableFilters[Kantor][value]=2', '_blank')",
                ])
                ->chart(generateRandomChartData(9)), // Replace 7 with the desired number of data points,
            ...
            Stat::make('SIAPKERJA', $TERDAFTARSIAPKERJA)
                ...
                ->extraAttributes([
                    'class' => 'cursor-pointer',
                    'onclick' => "window.open('/admin/data-pmis?tableFilters[Status][values][0]=2&tableFilters[siapkerja][value]=1&tableFilters[Kantor][value]=2', '_blank')",
                ])
                ->chart(generateRandomChartData(9)), // Replace 7 with the desired number of data points,
            ...
            Stat::make('ID SISKO BP2MI', $VERPP)
                ...
                ->extraAttributes([
                    'class' => 'cursor-pointer',
                    'onclick' => "window.open('/admin/data-pmis?tableFilters[Status][values][0]=2&tableFilters[verpp][value]=1&tableFilters[Kantor][value]=2', '_blank')",
                ])
                ->chart(generateRandomChartData(9)), // Replace 7 with the desired number of data points,
            ...
            Stat::make('TERBANG', $TERBANG)
                ...
                ->extraAttributes([
                    'class' => 'cursor-pointer',
                    'onclick' => "window.open('/admin/data-pmis?tableFilters[Status][values][0]=3&tableFilters[Kantor][value]=2', '_blank')",
                ])
                ->chart(generateRandomChartData(9)), // Replace 7 with the desired number of data points,
            ...
            Stat::make('FINISH', $PMIFINISH)
                ...
                ->extraAttributes([
                    'class' => 'cursor-pointer',
                    'onclick' => "window.open('/admin/data-pmis?tableFilters[Status][values][0]=4&tableFilters[Kantor][value]=2', '_blank')",
                ])
                ->chart(generateRandomChartData(9)), // Replace 7 with the desired number of data points,
            ...
            Stat::make('PENDING', $PMIPENDING)
                ...
                ->extraAttributes([
                    'class' => 'cursor-pointer',
                    'onclick' => "window.open('/admin/data-pmis?tableFilters[Status][values][0]=5&tableFilters[Kantor][value]=2', '_blank')",
                ])
                ->chart(generateRandomChartData(9)), // Replace 7 with the desired number of data points,
            ...
            Stat::make('MD', $PMIMD)
                ...
                ->extraAttributes([
                    'class' => 'cursor-pointer',
                    'onclick' => "window.open('/admin/data-pmis?tableFilters[Status][values][0]=6&tableFilters[Kantor][value]=2', '_blank')",
                ])
                ->chart(generateRandomChartData(9)), // Replace 7 with the desired number of data points,
